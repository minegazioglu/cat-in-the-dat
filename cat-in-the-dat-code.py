...
for train_index, test_index in skf.split(X, y):
    ...
    lrcv = LogisticRegressionCV(cv=2)
...
# Final Score(LogisticRegression):#0.7827177299920132 -- lasts 1:30 hours
# Final Score(LogisticRegressionCV) : #0.7810126444566058 -- lasts 30 minutes
